...
class KiCadCLI:
    ...
    def run_erc(self, schematic_path: Path, output_path: Path | None = None) -> ERCResult:
        """
    ...
    def export_netlist(
        self, schematic_path: Path, output_path: Path, format: str = "kicad"
    ) -> bool:
        """
    ...
    def export_pdf(
        self, schematic_path: Path, output_path: Path, black_and_white: bool = False
    ) -> bool:
        """
        ...
        cmd = [self.kicad_cli, "sch", "export", "pdf", "--output", str(output_path)]
    ...
    def export_svg(
        self, schematic_path: Path, output_dir: Path, black_and_white: bool = False
    ) -> bool:
        """
        ...
        cmd = [self.kicad_cli, "sch", "export", "svg", "--output", str(output_dir)]
    ...
    def run_drc(self, pcb_path: Path, output_path: Path | None = None) -> DRCResult:
        """
    ...
    def export_gerbers(
        self, pcb_path: Path, output_dir: Path, layers: list[str] | None = None
    ) -> bool:
        """
        ...
        cmd = [self.kicad_cli, "pcb", "export", "gerbers", "--output", str(output_dir)]
    ...
    def export_drill(self, pcb_path: Path, output_dir: Path, format: str = "excellon") -> bool:
        """
        Export drill files.
...
def validate_schematic(schematic_path: Path) -> dict[str, Any]:
    ...
    try:
        ...
        results["netlist"] = {"success": success, "path": str(netlist_path) if success else None}
    except Exception as e:
    ...
    try:
        ...
        results["bom"] = {"success": success, "path": str(bom_path) if success else None}
    except Exception as e:
    ...
    try:
        ...
        results["pdf"] = {"success": success, "path": str(pdf_path) if success else None}
    except Exception as e:
